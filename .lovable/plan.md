...
(`wild_spawn | field_alpha | dungeon | tower_boss | raid_altar | raid_egg | meteor_event |
quest_summon | sealed_realm | faction_base | pal_cage | fishing | unknown`) backed by a new
