...
import { ChefHat, ChevronDown, Flame, Info, Search, Sparkles, Utensils } from "lucide-react";
  ...
  if (loading || error || !knowledge) {
    return (
      <PackFeedback
        ...
        error={error}
        icon={Utensils}
        packName="Food Compendium"
        loadingBody="Preparing the cached offline food directory."
      />
    );
  }
          ...
          {showFood && (
            <div>
              ...
              {filteredItems.length === 0 ? (
                <EmptyState
                  title="No food items match your filter criteria."
                  body="Try adjusting your search or active filters."
                />
              ) : (
