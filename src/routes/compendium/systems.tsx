  ...
  if (loading || error || !knowledge || !filteredData) {
    return (
      <PackFeedback
        ...
        error={error}
        icon={Cpu}
        packName="Systems & Formulas"
        loadingBody="Preparing the cached offline systems directory."
      />
    );
  }
    ...
    <PageShell>
        ...
        <div className="flex flex-col gap-5 md:flex-row md:items-end md:justify-between">
          <div className="max-w-2xl">
            ...
            <p className="mt-3 text-sm leading-6 text-muted-foreground sm:text-base">
              Explore published Palworld game mechanics, breeding formulas, condensation, work speed
              levels, world settings, documented evidence gaps, and community-tier figures.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="flex items-start gap-2.5">
          ...
          <div>
            ...
            <p>
              ...
              in <code className="font-mono">src/lib/tiers.ts</code> remains 8. The work speed range
              of 0–10 describes reachable UI enhancement levels (including condensation and Applied
              Handbooks); base species work suitability stats cap at level 8.
            </p>
          </div>
        </div>
      </section>
      ...
      <Collapsible className="mt-5 rounded-xl border bg-card/60 p-4">
        ...
        <CollapsibleContent className="mt-3 text-xs leading-relaxed text-muted-foreground space-y-2">
          <p>
            This page documents 19 verified game mechanics alongside 10 explicit evidence gaps where
            exact formulas are unobtainable from public sources, as well as 3 community-derived
            figures.
          </p>
          <p>
            ...
            rather than filled with guesses or assumed values. No other Palworld resource documents
            this honestly.
          </p>
          <p>
      ...
      >
        ...
        {totalFilteredCount === 0 ? (
          <EmptyState
            title="No systems or evidence gaps match your search."
            body="Try searching for a different term or clearing filters."
          />
        ) : (
