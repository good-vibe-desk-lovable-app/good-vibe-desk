...
- https://game8.co (Community-tier empirical observations & guides)
...
def main() -> None:
    ...
    # Community-Tier System Records (3 target)
    community_systems: list[dict[str, object]] = [
        {
            "id": "community-element-effectiveness-multipliers",
            "system": "Combat Mechanics",
            "summary": "Element type effectiveness multipliers",
            "figure": "Super Effective: 2x, Dual Advantage: 4x, Not Very Effective: 0.5x, Neutral: 1x",
            "sourceUrl": "https://game8.co/games/Palworld/archives/439611",
            "secondarySourceUrl": "https://game8.co/games/Palworld/archives/445883",
            "sourceTier": "community",
            "method": "Standard community element matchup tables & guides",
            "note": "Community tier record from Game8. No game-file source or versioned datamine confirms this figure.",
        },
        {
            "id": "community-stab-damage-bonus",
            "system": "Combat Mechanics",
            "summary": "Same-Type Attack Bonus (STAB) damage bonus",
            "figure": "~20% damage bonus (+20% same-element attack boost)",
            "sourceUrl": "https://game8.co/games/Palworld/archives/445735",
            "sourceTier": "community",
            "method": "Game8 in-house empirical damage testing",
            "note": "Community tier record from Game8 testing. No game-file source or versioned datamine confirms this figure.",
        },
        {
            "id": "community-iv-inheritance-rates",
            "system": "Breeding & Stats",
            "summary": "Parent Individual Value (IV) inheritance rates",
            "figure": "At least 1 IV guaranteed from parent; ~30% chance from specific parent; ~40% random",
            "sourceUrl": "https://game8.co/games/Palworld/archives/444315",
            "sourceTier": "community",
            "method": "Empirical breeding sample count trial",
            "sampleSize": 107,
            "note": "Community tier record from Game8 107 breeding sample trial. No game-file source or versioned datamine confirms this figure.",
        },
    ]
    ...
    require_values(community_systems, page="emit-knowledge-systems.py", field="community_systems")
    ...
    if len(community_systems) != 3:
        raise SourceContractError(f"Expected 3 community system records, found {len(community_systems)}")

    total_records = len(published_systems) + len(system_gaps) + len(community_systems)
    if total_records != 32:
        raise SourceContractError(f"Expected 32 total system records, found {total_records}")
    ...
    print(f"3. Community System Records: Collected = {len(community_systems)}, Target = 3 (Match)")
    print(f"4. Total System Rows: Collected = {total_records}, Target = 32 (Match)")
    print("========================================")

    out: list[str] = [
        "// AUTO-GENERATED by scripts/emit-knowledge-systems.py. Do not hand-edit.",
        "// Palworld Systems, Formulas, Mechanics, Explicit Evidence Gaps, and Community Records.",
        ...
        "}",
        "",
        "export interface SystemCommunityRecord {",
        "  id: string;",
        "  system: string;",
        "  summary: string;",
        "  figure: string;",
        ...
        "  communitySystems: readonly SystemCommunityRecord[];",
        "}",
        "",
        ...
        f"    communitySystems: {js(community_systems)},",
        "  },",
        "  version: {",
        ...
        "    },",
        "    {",
        '      id: "game8-element-chart",',
        '      url: "https://game8.co/games/Palworld/archives/439611",',
        '      tier: "community",',
        f"      observedAt: {js(emitted_at)},",
        "    },",
        "    {",
        '      id: "game8-super-effective",',
        '      url: "https://game8.co/games/Palworld/archives/445883",',
        '      tier: "community",',
        f"      observedAt: {js(emitted_at)},",
        "    },",
        "    {",
        '      id: "game8-stab-explained",',
        '      url: "https://game8.co/games/Palworld/archives/445735",',
        '      tier: "community",',
        f"      observedAt: {js(emitted_at)},",
        "    },",
        "    {",
        '      id: "game8-iv-breeding",',
        '      url: "https://game8.co/games/Palworld/archives/444315",',
        '      tier: "community",',
        f"      observedAt: {js(emitted_at)},",
        "    },",
        "  ],",
        ...
        '    { field: "communitySystems", sourceIds: ["game8-element-chart", "game8-super-effective", "game8-stab-explained", "game8-iv-breeding"], confidence: "reported" },',
        "  ],",
        "  gaps: [",
        "    {",
    ...
    coverage = {
        ...
        "counts": {
            ...
            "communitySystems": len(community_systems),
        },
        "sourceUrls": [
            ...
            "https://game8.co/games/Palworld/archives/439611",
            "https://game8.co/games/Palworld/archives/445883",
            "https://game8.co/games/Palworld/archives/445735",
            "https://game8.co/games/Palworld/archives/444315",
        ],
    }
